...
public class CommentRecord extends TableRecordImpl<CommentRecord> implements Record5<UInteger, UInteger, UInteger, Timestamp, String> {

    private static final long serialVersionUID = -1078417088;
     ...
     */
    @Override
    public CommentRecord value1(UInteger value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public CommentRecord values(UInteger value1, UInteger value2, UInteger value3, Timestamp value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CommentRecord(UInteger id, UInteger userId, UInteger articleId, Timestamp timeStamp, String content) {
        super(Comment.COMMENT);
